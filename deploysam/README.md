...
This is a sample template for deploysam - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name deploysam --tail
```
...
```bash
aws cloudformation delete-stack --stack-name deploysam
```
